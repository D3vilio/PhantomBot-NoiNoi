...
import NoinoiRobot.modules.sql.welcome_sql as sql
import NoinoiRobot
...
from NoinoiRobot.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from NoinoiRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from NoinoiRobot.modules.helper_funcs.msg_types import get_welcome_type
from NoinoiRobot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from NoinoiRobot.modules.log_channel import loggable
from NoinoiRobot.modules.sql.global_bans_sql import is_user_gbanned
        ...
        if should_welc:
           ...
           # make kontol asu
            ...
            # Welcome yourself
                ...
                creator = None
                if not NoinoiRobot.ALLOW_CHATS:
