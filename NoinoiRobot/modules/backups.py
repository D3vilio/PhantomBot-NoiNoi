...
import NoinoiRobot.modules.sql.notes_sql as sql
from NoinoiRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from NoinoiRobot.__main__ import DATA_IMPORT
from NoinoiRobot.modules.helper_funcs.chat_status import user_admin
from NoinoiRobot.modules.helper_funcs.alternate import typing_action

# from NoinoiRobot.modules.rules import get_rules
import NoinoiRobot.modules.sql.rules_sql as rulessql

# from NoinoiRobot.modules.sql import warns_sql as warnssql
import NoinoiRobot.modules.sql.blacklist_sql as blacklistsql
from NoinoiRobot.modules.sql import disable_sql as disabledsql

# from NoinoiRobot.modules.sql import cust_filters_sql as filtersql
# import NoinoiRobot.modules.sql.welcome_sql as welcsql
import NoinoiRobot.modules.sql.locks_sql as locksql
from NoinoiRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("NoinoiRobot{}.backup".format(chat_id), "w") as f:
    ...
    os.remove("NoinoiRobot{}.backup".format(chat_id))  # Cleaning file
...
*Only for group owner:*
 ...
 ❍ /import: Reply to the backup file for the butler / NOINOI group to import as much as possible, making transfers very easy! \
