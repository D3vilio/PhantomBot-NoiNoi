...
from NoinoiRobot import aiohttpsession as session
from NoinoiRobot.modules.memek import arq
from NoinoiRobot import pbot as app
from NoinoiRobot.utils.errors import capture_err
from NoinoiRobot.utils.pastebin import paste
...
async def lyrics_func(_, message):
    ...
    __help__ = """
*THIS COMMAND IS FOR MEDIA*

/saavn - `reply to a sticker to me to tell you its file ID.`
