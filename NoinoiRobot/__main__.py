...
buttons = [
    [
        InlineKeyboardButton(text="✨ Update", url="https://t.me/seven_7_ring"),
        InlineKeyboardButton(text=" About", callback_data="noi_about"),
        InlineKeyboardButton(text="📣 support ", url="https://t.me/phantombot_support"),
    ...
    [
        ...
        InlineKeyboardButton(text="Aᴅᴅ ᴍᴇ ᴛᴏ ɢʀᴏᴜᴘ ✨", url="http://t.me/PhantomRo_Bot?startgroup=true"),
    ],
]


HELP_STRINGS = """
**Main commands:**  [ㅤ](https://telegra.ph/file/b1450b7803b0faa26cc25.jpg)
...
DONATE_STRING = """ʜᴇʜᴇ ʏᴏᴜ ᴄᴀɴ ᴅᴏɴᴇᴛ ғʀᴏᴍ ʜᴇᴀʀ!
 [Herox](https://t.me/yes_am_serious) ❤️
"""
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
            NOINOI_IMG, caption= "I a'm alive 📍 #Herox Join @seven_7_ring \n<b>I cant sleep.:</b> <code>{}</code>".format(
                uptime
            ),
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", url="https://t.me/phantombot_support")]]
            ),
        )
...
def noi_about_callback(update, context):
    ...
    if query.data == "noi_":
        ...
        query.message.edit_text(
            text=f" 🧩 Hear the phantom page."
            f"\n\n❍ Hey welcome hear to phantom's private page we are saying big thanks to you for using our bot."
            ...
            f"\n\n 💡 Powerd by @SEVEN_7_RING",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Noinoi's repo 📂", url="https://github.com/heroxxd"),],
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi.. ɪ'ᴀᴍ noinoi*
                 \nHere is the [sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ](https://github.com/heroxxd) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Updates 📍", url="https://t.me/seven_7_ring")
                 ]
                ]
            ),
        )
...
def get_help(update: Update, context: CallbackContext):
    ...
    if chat.type != chat.PRIVATE:
        if len(args) >= 2 and any(args[1].lower() == x for x in HELPABLE):
            ...
            return
        update.effective_message.reply_text(
            "💡 Hear all phantom commands menu is opend you can cheak the following menu bar click on buttons.",
            reply_markup=InlineKeyboardMarkup(
                [
                    [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "I Aᴍ Aʟɪᴠᴇ ok ? Any problem Dm **@herox_xd** 🔥")
        except Unauthorized:
            LOGGER.warning(
